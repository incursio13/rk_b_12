                ...
                <form action="#" method="post" enctype="multipart/form-data" >
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="cost" class="form-control" placeholder="Lokasi Kehilangan">
                    </div>
                    <div class="form-group">
                      <label>Tanggal</label>
                      <input type="text" name="capacity" class="form-control" placeholder="Tanggal Kehilangan" id="datepicker">
                    </div>
                    <div class="form-group">
